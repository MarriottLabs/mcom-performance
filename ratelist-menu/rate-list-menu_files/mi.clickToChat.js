...
var clickToChat = {
	...
	beaconToSiteCatalyst : function() {
		...
		if(typeof swa !== "undefined") { 
			swa.linkTrackVars	= 'prop46,eVar49,events';
			swa.linkTrackEvents = 'event56';
			swa.prop46 = customerID;
			swa.eVar49 = invitationName;
			swa.events = 'event56';
			void(swa.tl(this,'o','Agent Joins Session'));
		}
	},
	/*	get cookie function
	----------------------- */
